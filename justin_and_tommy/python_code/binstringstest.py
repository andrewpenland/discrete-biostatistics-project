...
class TestBinstrings(ut.TestCase):
      ...
      for n in range(1, SIZE + 1):
         for r in range(2, UNIF + 1):
            for j in range(0, ORD + 1):
               for k in range(1, n):
                  print("IN TEST SUITE (test_gen_strings): n={}, r= {}, j={}, k={}".format(n, r, j, k))
   ...
   def test_anyr_k1(self):
      for n in range(1, SIZE + 1):
         for r in range(3, UNIF):
            for j in range(ORD + 1):
               print("IN TEST SUITE (test_anyr_k1): n={}, r={}, j={}".format(n, r, j))
   ...
   def test_r3_anyk(self):
      for n in range(1, SIZE + 1):
         for j in range(ORD + 1):
            for k in range(2, n):
               print("IN TEST SUITE (test_r3_anyk): n={}, j={}, k={}".format(n, j, k))
   ...
   def test_anyr_anyk(self):
      for n in range(1, SIZE + 1):
         for r in range(3, UNIF + 1):
            for j in range(ORD + 1):
               for k in range(2, n):
                  print("IN TEST SUITE (test_anyr_anyk): n={}, r={}, j={}, k={}".format(n, r, j, k))
